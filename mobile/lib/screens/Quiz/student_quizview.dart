...
class StudentQuizView extends StatelessWidget {
  ...
  Widget body(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        body: ListView(
            padding: EdgeInsets.fromLTRB(size.width * 0.03, size.height * 0.070,
                              ...
                              ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    return QuizAttemptCard(
                                        ...
                                        multiple: state.quizViews[i].multiple ??
                                            false,
                                        size: size,
                            ...
                            ? Column(
                                children: [
                                  Container(
                                      ...
                                      child: state.quizAnswer.marks_obtained !=
                                              null
                                          ? Text(
