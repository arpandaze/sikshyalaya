...
def create_program(db: Session = Depends(deps.get_db), teacherNote_in: TeacherNoteCreate)-> Any:
...
def update_program(db: Session = Depends(deps.get_db), teachernote_id: int, teacherNote_update: TeacherNoteUpdate)-> Any:
