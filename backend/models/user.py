...
from .association_tables import user_course_association_table, user_permission_association_table
...
class User(Base):
    ...
    permissions = relationship("UserPermission", secondary=user_permission_association_table)
