...
from .association_tables import (assignment_group_association_table, assignment_instructor_association_table)
...
class Assignment(Base):
    ...
    group = relationship("Group", secondary= assignment_group_association_table, backref = "assignments")
